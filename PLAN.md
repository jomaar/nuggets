...
| 12 | Doppelt-kodiertes `contentHtml` reparieren | mittel | Manche Nuggets haben `contentHtml` als **JSON-stringifizierten String** gespeichert (literale `"…"` am Anfang/Ende) + rohen ChatGPT-Exporter-Ballast (`Powered by …`, `target=\"_blank\"`). Sichtbares `"` im Reader + Tiptap-Re-Normalisierung bei jedem Mount. Ursache vermutlich im Datei-Import. Bestehende Daten bereinigen + Import-Pfad fixen. Entdeckt 2026-06-08 bei TODO 11 |
